 ...
 * Run from repo root: node scripts/build-content-audit.cjs
 * For .xlsx output: npm install xlsx
 */
const fs = require('fs');
...
function main() {
  ...
  try {
    ...
    console.log('Tip: npm install xlsx for a single content-audit.xlsx with 3 sheets.');
    return;
  }
